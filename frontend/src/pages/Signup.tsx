        ...
        <div className="sleek-card p-12 bg-white/[0.01] border border-white/5 backdrop-blur-3xl">
          <div className="mb-12 space-y-4">
            ...
            <h1 className="text-5xl font-bold text-white tracking-tighter leading-tight">
              Identity <span className="text-white/40">Launchpad</span>
            </h1>
            <p className="text-white/20 text-sm font-medium">Provision your credentials to begin derivative lifecycle orchestration.</p>
          </div>
